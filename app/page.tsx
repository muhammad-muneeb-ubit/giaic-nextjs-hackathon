...
//         <div className="flex gap-[10px] mx-[100px]">
//           <Cardwosale name={"T-SHIRT WITH TAPE DETAILS"} clothimageUrl={"/image 1.png"} price={"120$"} ratingimageUrl={"/rating4.5.png"} />
//           <Cardwsale name={"SKINNY FIT JEANS"} clothimageUrl={"/image 2.png"} price={"240$"} ratingimageUrl={"/rating3.5.png"} removeprice={"260$"} off={"-20$"}/>
//           <Cardwosale name={"CHECKERED SHIRT"} clothimageUrl={"/image 3.png"} price={"180$"} ratingimageUrl={"/rating4.5.png"}/>
//           <Cardwsale name={"SLEEVE STRIPED T-SHIRT"} clothimageUrl={"/image 4.png"} price={"130$"} ratingimageUrl={"/rating4.5.png"}  removeprice={"160$"} off={"-30$"}/>
//         </div>
...
//         <div className="flex gap-[10px] mx-[100px]">
//           <Cardwsale name={"VERTICAL STRIPED SHIRT"} clothimageUrl={"/image 5.png"} price={"212$"} ratingimageUrl={"/rating5.png"}  removeprice={"232$"} off={"-20$"}/>
//           <Cardwosale name={"COURAGE GRAPHIC T-SHIRT"} clothimageUrl={"/image 6.png"} price={"145$"} ratingimageUrl={"/rating4.png"}/>
//           <Cardwosale name={"LOOSE FIT BERMUDA SHORTS"} clothimageUrl={"/image 7.png"} price={"80$"} ratingimageUrl={"/rating3.png"}/>
//           <Cardwosale name={"FADED SKINNY JEANS"} clothimageUrl={"/image 8.png"} price={"210$"} ratingimageUrl={"/rating4.5.png"} />
//         </div>
//         <div className="flex justify-center items-center">
//           <button className="border-black border-[1px] px-[80px] py-[15px] mt-[36px]  ">View All</button>
//         </div>
